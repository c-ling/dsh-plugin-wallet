...
```sh
dsh plugin --profile web add "github:c-ling/dsh-plugin-wallet#v1.3.1"
# 或：npx @deepseek-ai/dsh plugin --profile web add "github:c-ling/dsh-plugin-wallet#v1.3.1"
# 或：cd ~/.dsh/profiles/web && corepack pnpm add "github:c-ling/dsh-plugin-wallet#v1.3.1"
```
